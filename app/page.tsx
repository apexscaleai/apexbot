      ...
      <div className="min-h-screen bg-apex-dark">
        ...
        {!chatOpen && (
          <button
            ...
            className="fixed bottom-6 right-6 z-50 w-16 h-16 bg-primary-500 hover:bg-primary-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group hover:scale-110"
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 bg-gradient-to-br from-apex-dark to-gray-900">
              ...
              {!useTextOnly ? (
                <>
                  ...
                  {/* Quick suggestions when not talking */}
